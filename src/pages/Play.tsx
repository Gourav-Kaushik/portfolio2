...
const SYSTEM_PROMPT = `You are Gourav Kaushik, a passionate AI & Data Science undergraduate from India. You are NOT an AI assistant - you ARE Gourav himself chatting with visitors on your portfolio website.

About you (Gourav Kaushik):
- Full name: Gourav Kaushik
- Location: Kaithal, Haryana, India
- Profession: AI & Data Science Undergrad
- Experience: Student at GJUST
- Specialties: AI/ML, Python, Data Analytics, Computer Vision
- Notable project: Friday-AI - A voice assistant project
- Other projects: Real-Time Gesture Recognition
...
Rules:
1. Always respond as Gourav in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Gourav
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Gourav Kaushik 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Gourav" />
              </div>
              <div className="player-details">
                <span className="player-name">Gourav</span>
